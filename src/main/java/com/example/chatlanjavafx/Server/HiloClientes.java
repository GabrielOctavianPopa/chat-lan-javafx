package com.example.chatlanjavafx.Server;
...
public class HiloClientes implements Runnable {
    ...
    private final String URL = "jdbc:mysql://localhost:3306/chat_db"; // URL de la base de datos, cambiar el puerto si es necesario (3306 por defecto)
